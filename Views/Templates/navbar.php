<nav class="position-sticky navbar navbar-expand-lg navbar-dark bg-primary ">
  <div class="container-fluid">
    <a class="navbar-brand fs-4 fw-bold bg-light text-primary rounded-3" href="#">Karabook</a>
      ...
      <?php  if(DataValidator::isLogado()){?>
        <li class="nav-item">
          <a class="nav-link " href="#" tabindex="-1"><?php echo 'Seja bem vindo '.$_SESSION['nm_user']; ?></a>
                ...
                <li class="nav-item">
          <a class="nav-link " href="?classe=Usuario&metodo=deslogar" tabindex="-1" >Deslogar</a>
        </li>
      <?php } ?>
      </ul>
      <!--
